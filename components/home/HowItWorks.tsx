...
const Steps: steps[] = [
  ...
  },
  {
    ...
    label: "AI analysis",
    desc: "Our advance AI processes and analyzes your document instantly",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    label: "Get Summary",
    desc: "Recieve a clear, concise summary of your document",
  },
];

const StepItem = ({ icon, desc, label }: steps) => {
  return (
