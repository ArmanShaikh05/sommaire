          ...
          <div className="flex flex-col gap-2 min-[400px]:flex-row justify-center">
            <div>
              <Button
                variant={"link"}
                size={"lg"}
                className="w-full min-[400px]:w-auto bg-linear-to-r from-slate-900 to-rose-500 hover:from-rose-500 hover:to-slate-900 text-white transition-all duration-300 flex justify-center items-center hover:no-underline "
              >
                <Link href={"/#pricing"} className="flex w-full items-center p-6 ">
                  Get Started{" "}
