...
import { DEMO_SUMMARY } from "@/lib/constants";
    ...
    <section className="relative">
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        <div className="flex flex-col items-center text-center space-y-4">
          <div className="inline-flex items-center justify-center p-2 border-gray-500/20 border rounded-2xl bg-gray-100/80 backdrop-blur-xs mb-4">
            <Pizza className="w-6 h-6 text-rose-500" />
          </div>
          <div className="text-center mb-16">
            <h3 className="font-bold text-2xl md:text-3xl max-w-2xl mx-auto px-4 sm:px-6">
              Watch how sommaire transforms{" "}
              <span className="bg-linear-to-r from-rose-500 to-rose-700 text-transparent bg-clip-text">
