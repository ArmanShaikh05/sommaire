...
const PricingCard = ({ name, price, desc, items, paymentLink, id }: Plan) => {
  return (
    <div className="relative w-full max-w-lg hover:scale-105 transition-all duration-300">
      <div
        className={cn(
          "relative flex flex-col h-full gap-4 lg:gap-8 z-10 rounded-2xl border-[1px] border-gray-500/20 p-8",
