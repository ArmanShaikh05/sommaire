    ...
    <div className="flex gap-4 mb-4 justify-between">
      <div className="space-y-6">
        <div className="flex items-center flex-wrap gap-4">
          <Badge
            variant={"secondary"}
            className="relative px-4 text-sm py-2 font-medium bg-white/80 backdrop-blur-xs rounded-full hover:bg-white/90 transition-all duration-200 shadow-xs hover:shadow-md cursor-default"
          >
        ...
        <h1 className="text-2xl lg:text-4xl font-bold lg:tracking-tight text-muted-foreground">
